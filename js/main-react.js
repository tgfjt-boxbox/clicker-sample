...
var Clicks = (function (_React$Component) {
	function Clicks() {
		_classCallCheck(this, Clicks);

		_get(Object.getPrototypeOf(Clicks.prototype), "constructor", this).call(this);
		this.state = { clicks: 0 };
	}

	_inherits(Clicks, _React$Component);
		...
		value: function render() {
			return _react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						"a",
						{ href: "#", className: "btn", onClick: this.countup.bind(this) },
						"Click Me!"
					)
				)
			);
...
_react2["default"].render(_react2["default"].createElement(Clicks, null), document.getElementById("clicks"));
