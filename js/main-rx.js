...
},{"rx":4}],3:[function(require,module,exports){
var Rx = require('rx');
require('./dist/rx.dom');
module.exports = Rx;
},{"./dist/rx.dom":2,"rx":4}],4:[function(require,module,exports){
...
document.addEventListener('DOMContentLoaded', function () {
	...
	var clickCounter = _rx2['default'].Observable.fromEvent(btn, 'click');
	var count = document.getElementById('js-clicks');

	clickCounter.map(function (e) {
		e.preventDefault();
		return 1;
	}).startWith(0).scan(0, function (x, y) {
		return x + y;
	}).subscribe(function (x) {
		return count.innerHTML = x;
	});
});
